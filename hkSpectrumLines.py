...
def PlotSpectrumLines(ax, lineNameList = []):
    ...
    if(len(lineNameList)==0):
        for lineName, wavelength in zip(emissionLines['Line'], emissionLines['Wavelength / Å']):
            ...
            plt.annotate(lineName, xy=(wavelength, y+yMod), arrowprops=dict(arrowstyle='->', connectionstyle='arc3, rad=0.3'), xytext=(+25, -15), xycoords = 'data', textcoords='offset points')
        ...
        for lineName in lineNameList:
            ...
            for index in indexList:
                ...
                plt.annotate(lineName, xy=(wavelength, y), arrowprops=dict(arrowstyle='->', connectionstyle='arc3, rad=0.3'), xytext=(+25, -15), xycoords = 'data', textcoords='offset points')
